...
title: "Dos Prédios",
year: 2022,
cover: "https://i.scdn.co/image/ab67616d0000b273afdd3ee20cd7c4a636b07cce",
spotify: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Spotify_icon.svg/1982px-Spotify_icon.svg.png",
...
albumCards.innerHTML = ""; // Clear existing cards
  ...
  albumCards.appendChild(cardElement);
});

}

  function updateFilters(artistValue, yearValue) {
    artistFilter.value = artistValue;
    yearFilter.value = yearValue;
    updateAlbums();
}
...
function updateAlbums() {
  ...
  const artistMatch = artistValue === "all" || album.artist === artistValue;
  const yearMatch = yearValue === "all" || album.year === parseInt(yearValue);
...
searchBtn.addEventListener('click', () => {
  ...
  updateFilters("all", "all"); // Reset filters
  displayAlbums(filteredAlbums);
});

artistFilter.addEventListener("change", () =>
updateFilters(artistFilter.value, yearFilter.value));
